...
public class NotificationService {
    ...
    public void notifyToUser(
            String username, String type, String title, String message, String taskId, String taskKey) {
        // Lưu vào database
    ...
    // NOTIFY TO ADMINS
    public void notifyAdmins(String type, String title, String message, String taskId, String taskKey) {
        ...
        TaskNotification adminPayload =
                new TaskNotification(null, type, title, message, "ROLE_ADMIN", taskId, taskKey, LocalDateTime.now());
    ...
    public void broadcastStoryUpdate(String type, String title, String message, Long storyId, String username) {
        TaskNotification notification = new TaskNotification(
                null, type, title, message, username, String.valueOf(storyId), "STORY", LocalDateTime.now());
    ...
    public void broadcastTaskUpdate(
            String type, String title, String message, String taskId, String taskKey, String username) {
        TaskNotification notification =
                new TaskNotification(null, type, title, message, username, taskId, taskKey, LocalDateTime.now());
